...
var kazu = 30; // あらかじめ先読みしておくつぶやきの数。たぶん、30くらいにしても取得する速度はほとんど変わらない
//var dsp = 2; //１ページに表示する数
var dsp = 5; //１ページに表示する数
//var user = "ts_3156"; // ここを自分のユーザ名に変えてください
var user = "superelmer"; // ここを自分のユーザ名に変えてください
...
// ツイートの中にURLがあったら、自動でリンクにする。要望を受けて11/29に作成
// 別のタブで開くようにしてるけど、同じタブで開きたい場合は、「target='_blank'」を削除してください。
